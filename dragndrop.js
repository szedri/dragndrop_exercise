    ...
    function quizIsFinished(){
        var myDiv1 = document.getElementById("feedback").innerHTML = "<p><strong>Congratulations! You have successfully matched the<br> topoisomerase inhibitors with the correct category.</strong></p>";
        }
	...
	function resetFeedback(){
		var myDiv1 = document.getElementById("feedback").innerHTML = "";
	 }
